...
import photo from '../assets/lets.jpg'
        ...
        <div className='about-me-container'>
            <div className="about-me">
                <p className='about-me-paragraph'>
                    I'm Ibrahim and I love coding! I've spent the past year learning the ins and outs of being a great fullstack developer. My favorite stack is node js backend with a React based front end. I work everyday to make my projects clean, effecient, and looking amazing! Thanks for taking a look at my portfolio.
                </p>
                <div>
                    <img style={{maxWidth:'400px'}} src={photo} className='shot' />
                </div>
            </div>
            <div>
                <motion.ul
